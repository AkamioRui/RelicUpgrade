...
async function drawGraph(){
  /** @type {[{nodes:[{depth:number,price:number,succesR:number,detail:string,accept:string}],links:[{src:number,dst:number,chance:number}]}]} */
  ...
  console.log(document.getElementById('myrect').getBoundingClientRect());
  console.log(document.getElementsByTagName('svg')[0].getBoundingClientRect());

  console.log(jsondata[0].nodes.length);
